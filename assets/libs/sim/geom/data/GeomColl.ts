...
export class GeomColl extends GeomNav {
    ...
    public collAddColl(coll0_i: number, coll1_i: number): void {
        this._geom_arrays.up_colls_parents[coll1_i] = coll0_i;
    }
    /**
    ...
    public collRemoveColl(coll0_i: number, coll1_i: number): void {
        if (this._geom_arrays.up_colls_parents[coll0_i] == null) { return; } // deleted
        if (this._geom_arrays.up_colls_parents[coll1_i] === coll0_i) {
            this._geom_arrays.up_colls_parents[coll1_i] = null;
        }
    }
    /**
    ...
    public collGetParent(coll_i: number): number {
        return this._geom_arrays.up_colls_parents[coll_i];
    }
    /**
    ...
    public collSetParent(coll_i: number, parent_coll_i: number): void {
        this._geom_arrays.up_colls_parents[coll_i] = parent_coll_i;
    }
    /**
    ...
    public collClearParent(coll_i: number): void {
        this._geom_arrays.up_colls_parents[coll_i] = null;
    }
    /**
    ...
    public collGetAncestors(coll_i: number): number[] {
        ...
        let parent_coll_i: number = this._geom_arrays.up_colls_parents[coll_i];
        while (parent_coll_i !== undefined && parent_coll_i !== null) {
            ancestor_colls_i.push(parent_coll_i);
            parent_coll_i = this._geom_arrays.up_colls_parents[parent_coll_i];
        }
    ...
    public collIsAncestor(coll1_i: number, coll2_i: number): boolean {
        let parent_coll: TCollParent = this._geom_arrays.up_colls_parents[coll2_i];
        while (parent_coll !== undefined && parent_coll !== null) {
            parent_coll = this._geom_arrays.up_colls_parents[parent_coll];
